...
<br>
<br>
You can perform delete operation on our National Olympic Commitees of Tokyo2020 database Disciplines table: 
<br>
<br>
<style>
...
<form action="deletediscipline.php" method="POST">
<select name="disciplines">

<?php

$sql_command = "SELECT discipline_name FROM Disciplines";
