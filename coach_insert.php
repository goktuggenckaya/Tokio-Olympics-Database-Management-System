...
<html>
<head>
	<title> Coaches Table Insert Panel</title>
...
<br>
<br>
Here is our National Olympic Commitees of Tokyo2020 database Coaches table: 
<br>
<br>
...
<form action="insertcoach.php" method="POST">
	<input type="text" id="fname" name="dname" placeholder="Discipline name"><br>
	<input type="text" id="fname" name="cname" placeholder="Coach name"><br>
	<input type="text" id="fname" name="name" placeholder="Noc name"><br>
  <input type="text" id="fname" name="gname" placeholder="Gender"><br>
